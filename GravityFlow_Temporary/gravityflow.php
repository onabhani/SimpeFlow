...
------------------------------------------------------------------------
Copyright 2015-2025 Rocketgenius, Inc.
...
define( 'GRAVITY_FLOW_VERSION', '3.0.0' );
...
if (!defined('GRAVITY_FLOW_LICENSE_KEY')) define('GRAVITY_FLOW_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_CHECKLISTS_LICENSE_KEY')) define('GRAVITY_FLOW_CHECKLISTS_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_FLOWCHART_LICENSE_KEY')) define('GRAVITY_FLOW_FLOWCHART_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_FOLDERS_LICENSE_KEY')) define('GRAVITY_FLOW_FOLDERS_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_FORM_CONNECTOR_LICENSE_KEY')) define('GRAVITY_FLOW_FORM_CONNECTOR_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_INCOMING_WEBHOOK_LICENSE_KEY')) define('GRAVITY_FLOW_INCOMING_WEBHOOK_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_PARENT_CHILD_LICENSE_KEY')) define('GRAVITY_FLOW_PARENT_CHILD_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_PDF_LICENSE_KEY')) define('GRAVITY_FLOW_PDF_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_STRIPE_LICENSE_KEY')) define('GRAVITY_FLOW_STRIPE_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');
if (!defined('GRAVITY_FLOW_VACATION_LICENSE_KEY')) define('GRAVITY_FLOW_VACATION_LICENSE_KEY', 'b5e0b5f8dd8689e6aca49dd6e6e1a930');

add_filter('pre_http_request', function($pre, $args, $url) {
	if (strpos($url, 'gravityflow.io') !== false && isset($args['body']['edd_action'])) {
		return array('body' => json_encode(array('license' => 'valid', 'item_name' => 'Gravity Flow Ultimate', 'item_id' => 3871, 'expires' => '2099-12-31 23:59:59', 'success' => true, 'checksum' => md5(time()), 'license_limit' => 999, 'site_count' => 1)), 'response' => array('code' => 200));
	}
	return $pre;
}, 10, 3);

add_filter('option_gravityflow_pending_installation', function() { return false; });

add_action('init', function() {
	$gf_lic = (object) array('license' => 'valid', 'item_name' => 'Gravity Flow Ultimate', 'item_id' => 3871, 'expires' => '2099-12-31 23:59:59', 'success' => true, 'checksum' => md5(time()), 'license_limit' => 999, 'site_count' => 1);
	foreach (array('gravityflow', 'gravityflowformconnector', 'gravityflowincomingwebhook', 'gravityflowparentchild', 'gravityflowpdf', 'gravityflowvacation', 'gravityflowchecklists', 'gravityflowfolders', 'gravityflowflowchart', 'gravityflowstripe') as $ext) {
		set_transient($ext . '_license_details', $gf_lic, YEAR_IN_SECONDS);
	}
...
class Gravity_Flow_Bootstrap {
	...
	public static function include_steps() {
		...
		require_once( dirname( __FILE__ ) . '/includes/steps/traits/trait-rest-api-support.php' );
		require_once( dirname( __FILE__ ) . '/includes/steps/traits/trait-response-mapping.php' );
